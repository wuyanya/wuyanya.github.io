...
//记录发送记录
$_G['TABLE']['APP_PUYUETIAN_SMS_RECORD'] -> newData(array('pn' => $phonenumber, 'ip' => getClientInfos('ip'), 'state' => $r['state'], 'msg' => $r['datas']['msg'], 'date' => date('Ymd'), 'datetime' => date('Y-m-d H:i:s')));
if ($r['state'] == 'ok') {
